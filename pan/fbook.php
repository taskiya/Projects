...
<head>
        ...
        <title>Four wheeler booking</title>
<!--Boostrap css-->
...
<!--jquery-ui close-->
   ...
   <link href="css/fbook.css" type="text/css" rel="stylesheet">
</head>
...
<section>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="fbook.php">SECW</a>
                  ...
                  <div class="form-group">
                     <span class="form-label">Services</span>
                      <select class="form-control" name="service">
                         ...
                         <option>Echo Wash $199</option>
                         <option>Water Wash $350</option>
                         <option>Interior Wash $450</option>
                      </select>
                  </div>
